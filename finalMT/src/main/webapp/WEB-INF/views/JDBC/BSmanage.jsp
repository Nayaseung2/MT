			...
			<br/><br/>
				...
				<form action="insertJDBCstation.JDBC" method="post"  encType="multipart/form-data">
					<table class="insertBSTable" align="center">
						<tr>
							<th>방송국 이름</th>
							<td><input type="text" size="30" name="jdbc_name" style="margin-left:10px; height: 30px; border:1px solid lightgray;">
								<p style="margin-left:10px;">*방송국과 방송 화면에 보이는 이름입니다.(최대 한글 6자 영문 12자)<p></td>
						</tr>
						<tr>
							<th>방송국 소개</th>
							<td><input type="text" size="50" name="jdbc_introduce" style="margin-left:10px; height: 30px; border:1px solid lightgray;">
