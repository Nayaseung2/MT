	...
	<div class="LoginOuter">
		...
		<div class="findContainer">
			<div class="findDiv" align="center">
					...
					<h1>비밀번호 찾기</h1>
					<h4>* 가입하신 정보의 아이디와 이메일을 입력하시면, 이메일로 임시 비밀번호가 발송됩니다.</h4>
					<br/>
					
					<h3>아이디를 입력해주세요.</h3>
					<input type="text" class="inputBox" id="joinId" name="joinId" style="font-size:22px; width:180px;">
