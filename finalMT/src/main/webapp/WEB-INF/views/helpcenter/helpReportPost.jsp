	...
	<div class="outer">
		...
		<div class="rightNav">
			...
			<div align="center" class="csArea">
				<img src="${ contextPath }/resources/images/help/siren.png"/>
				<br/><br/>
				<h1>신고 내용이 정상적으로 접수되었습니다.</h1>
				<h3>모두의 TV 서비스 이용약관에 기존하여 서비스 운영원칙에 따라 불량이용자 처리 규정을 정하고 있습니다.<br/>모두의 TV 고객센터를 이용해주셔서 감사합니다.</h3>
			</div>					
