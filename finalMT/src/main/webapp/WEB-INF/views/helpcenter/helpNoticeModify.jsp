...
<body>
	...
	<div class="outer">
		...
		<div class="rightNav">
			...
			<br/>
				<div class="tableArea">
					<form action="helpnoticeModify.hp" method="post">
						<table align="center" id="listArea">
							<!-- table header -->
							<tr>
								<th colspan="3">
									<b>제 목</b>&nbsp;&nbsp;&nbsp;
									<input type="text" name="b_title" id="b_title" value="${ helpMainVoList[0].b_title }"> 
							...
							<tr>
								<td colspan="3" rowspan="10">
									<b>내용을 입력하세요.</b>
									<textarea rows="8" cols="80" class="conArea" name="b_content"><c:out value="${ helpMainVoList[0].b_content }"/></textarea>
								</td>
							</tr>
						</table>
						<br/>
						...
						<br/>
						<div align="center">
							<button type="submit" class="btn btn-danger" style="font-size:20px;">수정하기</button>
						</div>
					</form>
				</div>
				<br/>
