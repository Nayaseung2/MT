...
public class HelpMainVo implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7556972332237384545L;
	...
	public HelpMainVo(String b_code, String v_code, String b_type, String b_title, String b_content, String bwriter,
			String b_create_date, String b_update_date, String b_count, String b_status) {
		super();
		this.b_code = b_code;
		this.v_code = v_code;
		this.b_type = b_type;
	...
	public String toString() {
		return "HelpMainVo [b_code=" + b_code + ", v_code=" + v_code + ", b_type=" + b_type + ", b_title=" + b_title
